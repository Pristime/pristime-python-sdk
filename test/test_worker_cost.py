...
class TestWorkerCost(unittest.TestCase):
    """WorkerCost unit test stubs"""
    ...
    def make_instance(self, include_optional) -> WorkerCost:
        """Test WorkerCost
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `WorkerCost`
        """
        model = WorkerCost()
        if include_optional:
            return WorkerCost(
