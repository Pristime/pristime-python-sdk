...
class TestMaxConsecutiveWorkdays(unittest.TestCase):
    """MaxConsecutiveWorkdays unit test stubs"""
    ...
    def make_instance(self, include_optional) -> MaxConsecutiveWorkdays:
        """Test MaxConsecutiveWorkdays
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `MaxConsecutiveWorkdays`
        """
    ...
    def testMaxConsecutiveWorkdays(self):
        """Test MaxConsecutiveWorkdays"""
