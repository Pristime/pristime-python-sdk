...
class TestPeriodTimeConstraints(unittest.TestCase):
    """PeriodTimeConstraints unit test stubs"""
    ...
    def make_instance(self, include_optional) -> PeriodTimeConstraints:
        """Test PeriodTimeConstraints
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `PeriodTimeConstraints`
        """
        model = PeriodTimeConstraints()
        if include_optional:
            return PeriodTimeConstraints(
    ...
    def testPeriodTimeConstraints(self):
        """Test PeriodTimeConstraints"""
