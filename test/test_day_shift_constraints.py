...
class TestDayShiftConstraints(unittest.TestCase):
    """DayShiftConstraints unit test stubs"""
    ...
    def make_instance(self, include_optional) -> DayShiftConstraints:
        """Test DayShiftConstraints
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `DayShiftConstraints`
        """
        model = DayShiftConstraints()
        if include_optional:
            return DayShiftConstraints(
                max_count = 0.0
            )
        else:
            return DayShiftConstraints(
    ...
    def testDayShiftConstraints(self):
        """Test DayShiftConstraints"""
