...
class TestPeriodDayConstraints(unittest.TestCase):
    """PeriodDayConstraints unit test stubs"""
    ...
    def make_instance(self, include_optional) -> PeriodDayConstraints:
        """Test PeriodDayConstraints
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `PeriodDayConstraints`
        """
        model = PeriodDayConstraints()
        if include_optional:
            return PeriodDayConstraints(
    ...
    def testPeriodDayConstraints(self):
        """Test PeriodDayConstraints"""
