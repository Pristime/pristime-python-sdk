...
class Balances(BaseModel):
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        # override the default output from pydantic by calling `to_dict()` of overtime_balance
        if self.overtime_balance:
            _dict['overtime_balance'] = self.overtime_balance.to_dict()
        # override the default output from pydantic by calling `to_dict()` of flextime_balance
        if self.flextime_balance:
            _dict['flextime_balance'] = self.flextime_balance.to_dict()
        return _dict
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "flextime_balance": Balance.from_dict(obj["flextime_balance"]) if obj.get("flextime_balance") is not None else None
        })
        return _obj
