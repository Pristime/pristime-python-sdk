...
from pristime_sdk.rest import RESTResponseType
...
class WorkforceSchedulingApi:
    ...
    def create_schedule_job(
        ...
        :param schedule_state: (required)
        :type schedule_state: ScheduleState
        ...
        _param = self._create_schedule_job_serialize(
    ...
    @validate_call
    def create_schedule_job_with_http_info(
        self,
        schedule_state: ScheduleState,
        _request_timeout: Union[
            None,
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[ScheduleJobResponse]:
        """Create Workforce Schedule Optimization Job
    ...
    @validate_call
    def create_schedule_job_without_preload_content(
        self,
        schedule_state: ScheduleState,
        _request_timeout: Union[
            None,
    ...
    def _create_schedule_job_serialize(
        self,
        schedule_state,
        _request_auth,
        _content_type,
        ...
        return self.api_client.param_serialize(
            method='POST',
            resource_path='/api/v2/schedule-jobs',
    ...
    def get_schedule_job(
        ...
        _param = self._get_schedule_job_serialize(
            job_id=job_id,
            _request_auth=_request_auth,
            _content_type=_content_type,
            _headers=_headers,
    ...
    @validate_call
    def get_schedule_job_with_http_info(
        self,
        job_id: StrictStr,
        _request_timeout: Union[
            None,
    ...
    @validate_call
    def get_schedule_job_without_preload_content(
        self,
        job_id: StrictStr,
        _request_timeout: Union[
            None,
    ...
    def _get_schedule_job_serialize(
        self,
        job_id,
        _request_auth,
        _content_type,
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/api/v2/schedule-jobs/{job_id}',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
