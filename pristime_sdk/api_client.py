...
from pristime_sdk.configuration import Configuration
from pristime_sdk.api_response import ApiResponse, T as ApiResponseT
import pristime_sdk.models
from pristime_sdk import rest
from pristime_sdk.exceptions import (
    ApiValueError,
    ApiException,
    BadRequestException,
    ...
    def __deserialize(self, data, klass):
        ...
        if isinstance(klass, str):
            ...
            if klass in self.NATIVE_TYPES_MAPPING:
                ...
                klass = getattr(pristime_sdk.models, klass)
